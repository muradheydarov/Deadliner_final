...
namespace WebApplication1.Controllers
{
    public class TasksModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TasksModelID,Heading,Content,StartDate,EndDate,CreatedBy,CreatedOn,Status")] TasksModel tasksModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TasksModelID,Heading,Content,StartDate,EndDate,CreatedBy,CreatedOn,Status")] TasksModel tasksModel)
        {
            if (ModelState.IsValid)
            {
